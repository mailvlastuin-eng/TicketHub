            ...
            >
              ...
              <div className="w-1/3 flex flex-col bg-white">
                ...
                <div className="px-[20px] py-[24px] flex flex-col gap-4">
                  {/* Select From Contacts Button (Appears active, does nothing) */}
                  <button
                    onClick={() => {}}
                  ...
                  <div className="flex flex-col items-center justify-center mt-8 pb-10">
                    <div className="w-[64px] h-[64px] rounded-full bg-[#F0F2F5] flex items-center justify-center mb-6">
                      <svg 
                        className="w-[28px] h-[28px] text-[#4B5563] relative -left-[1px] top-[1px]" 
                        viewBox="0 0 24 24" 
                        fill="none" 
                        stroke="currentColor" 
                        strokeWidth="1.8" 
...
function SeatCell({
  ...
  return (
    <div className={alignmentClass}>
      ...
      <p className="text-[15px] font-black text-black mt-0.5 leading-none">{value}</p>
    </div>
  );
}
    ...
    <div className="flex flex-col gap-[2px] w-full select-none">
      ...
      <div className="bg-[#eaeaea] px-5 py-[14.5px] rounded-none grid grid-cols-2 gap-2">
        <div className="text-left">
          ...
          <p className="text-[15px] font-black text-black mt-0.5 leading-none">{entry.section || "GA"}</p>
        </div>
