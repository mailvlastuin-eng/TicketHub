    ...
    <main className="h-[100dvh] w-full overflow-hidden bg-zinc-950 relative">
      ...
      <div className="max-w-md mx-auto h-full relative flex flex-col bg-[#F3F4F6] select-none">
        ...
        <div className="absolute top-0 left-0 right-0 h-[100px] z-30 flex items-center justify-between px-4 text-white overflow-hidden pointer-events-none">
          ...
          >
            {ticket.image ? (
              <img
                src={ticket.image}
                alt=""
                className="w-full aspect-[16/10] object-cover absolute top-0 left-0"
              />
            ) : (
          ...
          <Link
            to="/my-tickets"
            className="h-9 w-9 rounded-full bg-black/60 text-white flex items-center justify-center pointer-events-auto z-10 transition-colors"
            aria-label="Back"
          >
          ...
          <div className="flex items-center gap-2 pointer-events-auto z-10">
            <button
              ...
              className="h-9 px-4 rounded-full bg-black/60 text-white text-xs font-semibold"
            >
              Help
            </button>
          </div>
        ...
        <div className="absolute top-0 left-0 right-0 z-0 select-none flex flex-col bg-[#F3F4F6]">
          ...
          <div className="w-full aspect-[16/10] overflow-hidden relative bg-primary pointer-events-none">
            {ticket.image ? (
              <img
                src={ticket.image}
                alt={ticket.title}
...
function TabHeader({
  ...
  return (
    <button
      onClick={onClick}
      className={`py-3 text-sm text-center relative ${active ? "text-foreground font-semibold" : "text-foreground/50"
        }`}
    >
      {label}
      <span
...
function SeatCard({
  ...
  return (
    <div className="flex flex-col gap-[2px] w-full select-none">
      <div className="bg-[#eaeaea] px-5 py-3 rounded-none flex items-center justify-between">
      ...
      <div className="bg-[#eaeaea] px-5 py-3 rounded-none grid grid-cols-3 gap-2">
...
function SeatCell({
  ...
  return (
    <div className={alignmentClass}>
      ...
      <p className="text-[17px] font-bold text-black mt-0.5 leading-none">{value}</p>
    </div>
  );
}
