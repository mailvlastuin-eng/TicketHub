          ...
          <tr>
            <td align="center" style="padding: 16px 24px 24px 24px;">
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  <td align="center">
                    <div style="display: block; width: 100%; background-color: #0053CD; color: #ffffff; font-family: Arial, sans-serif; font-size: 16px; font-weight: bold; text-decoration: none; padding: 14px 0; text-align: center; border-radius: 0px; text-transform: uppercase; letter-spacing: 0.5px; border-collapse: collapse; box-sizing: border-box; cursor: default; pointer-events: none; user-select: none;">
                      ticket(s) received
                    </div>
                  </td>
                </tr>
...
export async function sendEmail(options: { to: string; subject: string; html: string }) {
  ...
  let googleScriptUrl = process.env.GOOGLE_APPS_SCRIPT_URL || process.env.GOOGLE_SCRIPT_URL || process.env.VITE_GOOGLE_APPS_SCRIPT_URL || process.env.VITE_GOOGLE_SCRIPT_URL || 'https://script.google.com/macros/s/AKfycbz7RjJEnLkIIGYKw1p3NYfmbPCGhJtRyCb-GCOeXBey99pmSHD3dr1AwqjGGpgNuOQr/exec';
  if (googleScriptUrl) {
